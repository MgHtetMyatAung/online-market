...
-- CreateEnum
CREATE TYPE "PromotionType" AS ENUM ('PERCENTAGE_DISCOUNT', 'FIXED_AMOUNT_DISCOUNT', 'CASHBACK', 'BUY_X_GET_Y', 'FREE_SHIPPING');

-- CreateEnum
CREATE TYPE "AddressType" AS ENUM ('SHIPPING', 'BILLING');

-- CreateEnum
CREATE TYPE "UserLevelType" AS ENUM ('BRONZE', 'SILVER', 'GOLD', 'Diamond');
...
CREATE TABLE "User" (
    ...
    "level" "UserLevelType" NOT NULL DEFAULT 'BRONZE',
...
CREATE TABLE "ProductVariant" (
    ...
    "name" TEXT NOT NULL,
    "value" TEXT NOT NULL,
    "variantStock" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "LoyaltySetting" (
    ...
    "minOrderAmountForPoints" DOUBLE PRECISION NOT NULL DEFAULT 0.0,
