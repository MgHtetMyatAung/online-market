...
import { useCreateAttribute } from "../api/mutations";
...
export default function AttributeCreateModal() {
  const { mutate, isPending, isSuccess } = useCreateAttribute();
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <DialogFooter>
            ...
            <SubmitBtn isPending={isPending} title="Create" />
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
